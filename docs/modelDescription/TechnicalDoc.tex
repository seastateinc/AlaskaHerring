    ...
    \begin{itemize}
      ...
      \item The model has 5 major components:
        \begin{enumerate}
          ...
          \item Statistical criterion: or the objective function that relates the observations to the predicted observations based on population and observation model dynamics.

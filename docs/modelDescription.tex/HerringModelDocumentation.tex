...
\begin{document}
  ...
  \subsubsection{Initial state variables.} % (fold)
    ...
    \lstinputlisting[language=C++, firstline=729, lastline=792]{../../src/ham.tpl}
    ...
    \begin{small}
    \lstinputlisting[language=C++, firstline=795, lastline=860]{../../src/ham.tpl}
  ...
  \label{sub:observation_models}
    ...
    \lstinputlisting[language=C++, firstline=864, lastline=885]{../../src/ham.tpl}
